...
{
    c.SwaggerDoc("v1", new() { Title = "Servi�o de Usu�rios e Autentica��o", Version = "v1", Description = "Este servi�o � o \"dono\" da identidade do usu�rio. Ele gerencia quem s�o os usu�rios e como eles se autenticam." });
    c.EnableAnnotations();
